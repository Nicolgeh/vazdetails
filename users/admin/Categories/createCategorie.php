...
<body>
    ...
    <div class="container">
        ...
        <form class="m-auto col-10 col-md-6 w-70" method="POST">
            ...
            <div class="row">
                <div class="col-sm-3 col-md-10 mb-4">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="checkCategorie" id="flexRadioDefault1" value="0" checked>
                        <label class="form-check-label" for="flexRadioDefault1">
                            Машины
                        </label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input " type="radio" name="checkCategorie" id="flexRadioDefault2" value="1">
                        <label class="form-check-label " for="flexRadioDefault2">
                            Категория
                        </label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input " type="radio" name="checkCategorie" id="flexRadioDefault2" value="2">
                        <label class="form-check-label " for="flexRadioDefault2">
                            Подкатегория
                        </label>
                    </div>
            ...
            <!-- Submit button -->
            <button name="button-create-categorie" type="submit" class="btn btn-primary btn-block mb-4 w-100">Создать</button>
