...
<body>
    ...
    <div class="container">
        ...
        <form class="m-auto col-10 col-md-6 w-70" method="POST" enctype="multipart/form-data">
            <div class="card-body text-center mb-4">
                <img src="../../../assets/images/details/preview.png" alt="detail" class="img-fluid" style="width: 100%;">
            ...
            <!-- Submit button -->
            <button name="button-create-item" type="submit" class="btn btn-primary btn-block mb-4 w-100">Создать</button>
