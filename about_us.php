...
<body>
    ...
    <div class="container">
        <div class="p-4 mb-3 bg-dark rounded">
            ...
            <p class="mb-0 text-white">Перспективная команда по продаже оригинальных/переделанных деталей для отечественного автопрома напрямую от производителя</p>
            <p class="mb-0 text-white">Боремся за цену/качество/время нашего товара</p>
        </div>
        <div class="p-4 mb-3 bg-dark rounded">
            ...
            <p class="mb-0 text-white">Также доставка по Тольятти/Самара в руки</p>
        </div>
        <div class="p-4 mb-3 bg-dark rounded">
            <h4 class="fst-italic text-white">Мы - Качество</h4>
            <p class="mb-0 text-white">Только лучшие запчасти, только со станка</p>
            <p class="mb-0 text-white">Хорошо запакованны с наименьшем шансом брака</p>
        </div>
        <div class="p-4 mb-3 bg-dark rounded">
            ...
            <p class="mb-0 text-white">Доставка в случае возврата за наш счет</p>
        </div>
        <div class="p-4 mb-3 bg-dark rounded">
            ...
            <p class="mb-0 text-white">Всегда только актуальные детали</p>
        </div>
    </div>
