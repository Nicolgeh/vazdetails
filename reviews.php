...
<body>
    ...
    <div class="container">
        <div class="img-single">
            <img class="d-block w-100" src="assets/images/reviews/calina1.jpg" alt="fary2110">
        </div>
    </div>
        ...
        <div class="category-single col-xs-12 col-md-12">
            <table class="table">
                ...
                <tr>
                    ...
                    <th scope="col"><a href="#">Калина 1</a></th>
                    <th scope="col">5 июня 2023</th>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="container">
        <div class="description-single">
            <p><h4>Описание:</h4>  Отлично подошли новые фары, хорошо светят, не слепят других водителей.</p>
